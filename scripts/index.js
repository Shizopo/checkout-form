...
const data = [
  {
    ...
    urgency: "I got time",
    text:
      "With an timeline set up, our expert will forget about deadlines and provide good result."
  },
  {
    id: 1,
    urgency: "average",
    text:
      "With an timeline set up, our expert translator can take a reasonable amount of time perfecting your translation"
  },
  {
    id: 2,
    urgency: "yesterday",
  ...
  switch (parseInt(this.value)) {
    ...
    case 2:
      ...
      for (let i = 0; i < urgencyLabelPoint.length; i++) {
        urgencyLabelPoint[i].classList.contains("orange-text")
          ? urgencyLabelPoint[i].classList.remove("orange-text")
          : false;
      }
